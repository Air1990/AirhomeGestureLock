...
public class GestureLockView extends RelativeLayout {
    ...
    public GestureLockView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a=context.obtainStyledAttributes(attrs,R.styleable.GestureLockView,defStyleAttr,0);
        aroundMargin=a.getDimensionPixelSize(R.styleable.GestureLockView_around_margin,30);
        a.recycle();
        Log.d(TAG, "aroundMargin: "+aroundMargin);
        DisplayMetrics displayMetrics = getContext().getResources().getDisplayMetrics();
        int screenWidth = displayMetrics.widthPixels;
        LockView lockView=new LockView(context);
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(screenWidth-aroundMargin,
                screenWidth-aroundMargin);
    ...
    private class LockView extends View {
        ...
        private void initSize() {
            ...
            mCircleRadius = (screenWidth / 12);
            mPointRadius = mCircleRadius / 4;
            mLineWidth = mPointRadius / 2;
            mCircleWidth = mLineWidth / 2;
            Log.i(TAG, String.valueOf(screenWidth));
            Log.i(TAG, "==densityDpi==" + String.valueOf(density));
            Log.i(TAG, "==mCircleRadius==" + String.valueOf(mCircleRadius));
            Log.i(TAG, "==mPointRadius==" + String.valueOf(mPointRadius));
            Log.i(TAG, "==mLineWidth==" + String.valueOf(mLineWidth));
            Log.i(TAG, "==mCircleWidth==" + String.valueOf(mCircleWidth));
        }
        ...
        private void initView() {
            ...
            int offset = (int) (mCircleRadius * 2)-aroundMargin/2;
            int space = (int) mCircleRadius;
            mPoint[0][0] = new Point(offset + mCircleRadius, offset + mCircleRadius);
            mPoint[0][1] = new Point(offset + space * 4, offset + mCircleRadius);
            mPoint[0][2] = new Point(offset + space * 7, offset + mCircleRadius);

            mPoint[1][0] = new Point(offset + mCircleRadius, offset + space * 4);
            mPoint[1][1] = new Point(offset + space * 4, offset + space * 4);
            mPoint[1][2] = new Point(offset + space * 7, offset + space * 4);

            mPoint[2][0] = new Point(offset + mCircleRadius, offset + space * 7);
            mPoint[2][1] = new Point(offset + space * 4, offset + space * 7);
            mPoint[2][2] = new Point(offset + space * 7, offset + space * 7);
        }
